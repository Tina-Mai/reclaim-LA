			...
			<div className="vertical max-w-prose gap-6">
				...
				<div className="vertical gap-2">
					...
					<ul className="list-decimal list-outside pl-4">
						...
						<li>
							Data Deletion: We automatically delete your personal data and transcripts after 30 days unless you request otherwise. You can request data deletion or copies of your data
							at any time by emailing team@reclaimAI.org.
						</li>
					</ul>
				</div>
				<div className="vertical gap-2">
				...
				<div className="vertical gap-2">
					...
					<p>
						We reserve the right to suspend or terminate your access to the Site or Services at any time, with or without cause or notice, if we believe you have violated these Terms or
				...
				<div className="vertical gap-2">
					...
					<p>
						...
						changes, we will notify you by posting a notice on our Site or sending an email to the address associated with your account. Your continued use of the Site or Services after
						the changes become effective constitutes your acceptance of the revised Terms.
					</p>
				</div>
				<div className="vertical gap-2">
					...
					<p>
						...
						related to these Terms or your use of the Services shall be brought in the state or federal courts located in California, and you consent to the exclusive jurisdiction of such
						courts.
					</p>
				</div>
				<div className="vertical gap-2">
