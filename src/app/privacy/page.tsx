...
export default function Privacy() {
	return (
		<div className="vertical w-full justify-center items-center pt-28 md:pt-32 pb-12 px-5 text-sm">
			<Header />
			<div className="vertical max-w-prose gap-6">
				...
				<div className="vertical gap-2">
					...
					<ul className="list-decimal list-outside pl-4">
						...
						<li>
							Usage Data: We may collect non-personal information about how you interact with our website and services (e.g., browser type, device information, pages visited, and time
							spent on each page).
						</li>
					</ul>
				</div>
				...
				<div className="vertical gap-2">
					...
					<ul className="list-decimal list-outside pl-4">
						<li>
							Retention Period: We store your personal information and call transcriptions for up to one month (30 days) unless you request otherwise. After this period, we automatically
							delete all collected data from our systems.
						</li>
				...
				<div className="vertical gap-2">
					...
					<ul className="list-decimal list-outside pl-4">
						<li>
							Security Measures: We implement reasonable and appropriate technical, administrative, and physical safeguards designed to protect your information from unauthorized access,
				...
				<div className="vertical gap-2">
					...
					<p>
						We may update this Privacy Policy from time to time to reflect changes in our practices or for other operational, legal, or regulatory reasons. If we make material changes, we
						will provide a notice on our website or notify you via email prior to the changes becoming effective.
					</p>
				</div>
				<div className="vertical gap-2">
