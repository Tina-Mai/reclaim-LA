	...
	return (
		<main>
			<div className="vertical min-h-[calc(100dvh)] justify-center items-center">
				<Header />
				<div className="vertical gap-8 sm:gap-10 max-w-screen-md justify-center items-center pt-28 md:pt-36 pb-12 px-5 animate-fade-in-up">
					...
					<div className="vertical justify-center items-center text-center text-sm text-zinc-800 gap-2 opacity-50 animate-fade-in delay-400">
						<div>Built by students at</div>
						<Image src="/stanford-logo.png" alt="Logo" width={100} height={100} className="grayscale" />
					</div>
				</div>
				<div className="w-full relative -z-10 -mt-[27rem] md:-mt-96 h-[100vh] md:h-[90vh] animate-fade-in">
			...
			<div className="vertical justify-center items-center pt-12 p-5 gap-8 animate-fade-in-up delay-600">
